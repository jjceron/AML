...
% Nodos del medio
\node[box, below right=2cm and -0.005cm of likelihood] (bayesian) {Bayesian \\ (Prior $p(\theta)$)};
\node[box, below left=2cm and -0.5cm of likelihood] (frequentist) {Frequentist \\ (No priors)};
